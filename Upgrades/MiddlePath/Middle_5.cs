...
namespace PalutenMod.Upgrades.MiddlePath
{
    public class Middle_5 : ModUpgrade<PalutenTower>
    {
        ...
        public override string Description => "He gets shorter cooldowns and a Star Ability";
        ...
        public override void ApplyUpgrade(TowerModel tower)
        {
            ...
            tower.GetWeapon().Rate *= 0.85f;
            projectilePV.GetDamageModel().damage += 4;
            ...
            projectileModel.GetDamageModel().damage = 350;
            ...
            {
                damageModifierForTagModel.damageAddative = 27;
            }
            ...
            projectileModel2.GetDamageModel().damage = 1500;
            ...
            {
                damageModifierForTagModel.damageAddative = 10;
            }
            ...
            projectileModel3.GetDamageModel().damage = 200;
            ...
            projectileModel4.GetDamageModel().damage = 10000;
